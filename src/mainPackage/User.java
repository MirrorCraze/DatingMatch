...
public class User {
	...
	public User(String fullName, char gender, int age, int upperAgeBound, int lowerAgeBound, int yearOfBirth,double lat, double lon)
	{
	...
	public int calculateScore(User u)
	{
		...
		double age_score=(-25.00/26.00)*d+50;
